                    ...
                    for message in all_messages:
                        if message['authorAlias'] != self.chat_state[room_id]['my_alias']:
                            ...
                            if message['ordinal'] not in self.chat_state[room_id]['messages']:
                                ...
                                results = 'Try: http://www.wikidata.org/entity/Q14536 or try wd:Q14536'
                                self.post_message(room_id=room_id, session_token=self.session_token, message='Got your message: \n\'{}\' at {}. The results of your query is: \n {}'.format(message['message'], self.get_time(), str(results)))
